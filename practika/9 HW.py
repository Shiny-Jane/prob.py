# Даны два кортежа: C_1 = (35, 78,21,37, 2,98, 6, 100, 231)   и  C_2 = (45, 21,124,76,5,23,91,234)
...
print(C_1.index(min(C_1)), C_1.index(max(C_1)))  # индекс наименьшего элемента, индекс наибольшего элемента
